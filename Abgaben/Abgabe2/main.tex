...
\section{Bilderkennung}
    ...
    Mit der HSV-Maske können wir das Bild in eine binäre Darstellung überführen, in der Pixel mit HSV-Werten innerhalb der definierten Grenzen als weiße Pixel und Pixel mit Werten außerhalb der Grenzen als schwarze Pixel dargestellt werden.\todo[inline]{TODO:\@ hier würde ich eher die Abbildung 1 referenzieren, vorausgesetzt der rechte Teil stellt das erwähnte binäre Bild da}
